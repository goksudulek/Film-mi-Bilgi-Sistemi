			...
			<div class="col-md-8 col-sm-8  ">
                ...
                <div class="x_panel">
                  <div class="x_title">
					...
					$filmID = $_GET["filmID"]; #get ile sirketID değerini sirketler.php sayfasından aldık.
					...
					if($_POST['updatefilm']){ #updatesirket butonuna basılırsa aşağıdaki işlemleri yap
